...
/**
 * Created by sr01001 on 27/01/2016.
 */
import java.awt.*;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().compareTo("Paste") == 0) {
            ...
            try {
                ...
                System.out.println("Rowss: " + numrows);
                System.out.println("Tokens: " + st1.countTokens());

                if(numrows < st1.countTokens()){

                        DefaultTableModel tbl = new DefaultTableModel(st1.countTokens(),4);
                        tbl.setColumnIdentifiers(getColumnNames(jTable1));
